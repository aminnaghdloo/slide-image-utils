...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output', type=str, help='Output HDF5 file',
                        required=True)
    parser.add_argument('-m', '--mask_flag', action='store_true', default=False,
                        help='merge the masks')
    parser.add_argument('-a', '--add_filename', type=str, default=None,
    ...
    for input_file in args.input:
        ...
        if args.add_filename is not None:
            df.insert(0, args.add_filename, filename)
