...
def process_frame(frame_info, params):
	...
	features = frame.calc_event_features(
		func=calc_hist, channel=params['target_channel'],
...
if __name__ == '__main__':
	...
	parser.add_argument(
		'-T', '--target_channel', type=str, default='CY5',
		help="target channel name")

	parser.add_argument(
		'-p', '--prefix', type=str, default='bin',
	...
	if args.target_channel not in args.channels:
		logger.error(f"target channel {args.target_channel} is not found in "
